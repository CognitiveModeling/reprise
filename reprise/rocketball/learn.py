...
def train():
    ...
    # CONSTANTS
    NUM_EPOCHS = 500  # Amount of epochs of size NUM_MINI_EPOCHS
    NUM_MINI_EPOCHS = 5  # Amount of mini-epochs of size NUM_TIME_STEPS
    NUM_TIME_STEPS = 30
    LEARNING_RATE = 0.01
    ...
    agents = []
    a1 = Agent(id='D', color='red', init_pos=np.array([0., 1.]), lr=LEARNING_RATE , gui=gui, sim=sim, num_epochs=NUM_EPOCHS)
    agents.append(a1)
    ...
    obstacles = create_obstacles(10, gui=gui, sim=sim)
